...
namespace AlterBotNet.Core.Commands
{
    ...
    {
        public static List<Spell> PublicGrimSpells = Global.ChargerDonneesSpellXml(Global.CheminGrimoirePublic)[0].Spells;
        ...
        public static Spell FindSpell(string nomSpell)
        {
            ...
            Spell spell = (from s in PublicGrim.PublicGrimSpells
